...
import { type ScrapeRequest, type ScrapeDataContentDefn, defaultScrapeRequest, TableTypeDefn, SectionTypeDefn, TextTypeDefn, ColumnMapDefn } from "@/types.ts"
...
export default function ScraperForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:7000/scraper/scrape/url/start", {
                method: "POST",
                headers: {
            ...
            if (response.ok) {
                ...
                console.log("Scraper job started:", result)
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
            ...
            <div>
                ...
                <span className="text-red-500 font-bold">*</span>
                <Select value={request.config?.scrape_phase?.library} onValueChange={handleSelectChange("scrapePhaseLibrary")} required>
                    <SelectTrigger>
            ...
            <div>
                ...
                <Select value={request.config?.process_phase?.library} onValueChange={handleSelectChange("processPhaseLibrary")}>
                    <SelectTrigger>
